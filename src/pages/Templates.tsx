      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="bg-card border border-amber-200 rounded-2xl p-5 sm:p-6 shadow-sm mb-5 flex items-start gap-3">
          ...
          <p className="text-sm text-foreground/85 leading-relaxed">
            Срок действия тарифа начнётся с {LAUNCH_DATE} года — в день официального запуска приложения, даже
            если вы подключили тариф раньше. Готовить документы можно уже сейчас, а вот отправка документов
            клиенту на подпись по СМС станет доступна только с {LAUNCH_DATE}.
          </p>
        </div>
