...
const problems = [
  ...
  },
  {
    icon: "XCircle",
    tag: "Бездействие",
    title: "Страх порождает полное отсутствие учёта",
    text: "Вместо того чтобы рискнуть ошибиться, специалист просто не ведёт документы вовсе. Никаких договоров, никаких актов — только надежда, что «пронесёт».",
  },
  {
    icon: "DoorOpen",
