      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm mb-8">
          ...
          <Section n="4" title="Подтверждение электронной почты" status="planned">
            ...
            <Li><span className="text-amber-700">Отправка писем требует сервиса рассылки (Unisender Go / SendPulse) и служебного адреса вида noreply@zavdoc.ru — вынесено в отложенные задачи.</span></Li>
          </Section>
