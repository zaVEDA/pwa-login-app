...
const paidPlans = [
  ...
  { id: "pro", label: "Творец", desc: "Безграничное создание документов, до 88 подписей по СМС в месяц, можно добавить свой шаблон договора", icon: "PenTool", month: 7777, halfYear: 38888, presaleHalfYear: 33777 },
];
