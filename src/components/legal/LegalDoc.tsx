...
export default function LegalDoc({ src, downloadUrl, downloadName, downloadLabel, notice }: LegalDocProps) {
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6">
        <div className="flex items-center justify-between gap-3 mb-5">
          ...
          {downloadUrl && (
            ...
            >
              <Icon name="Download" size={16} /> {downloadLabel || "Скачать PDF"}
            </a>
          )}
        </div>

        {notice && (
          <div className="mb-4 px-4 py-3 rounded-xl bg-amber-50 border border-amber-200 flex items-start gap-2.5">
            <Icon name="Eye" size={16} className="text-amber-600 flex-shrink-0 mt-0.5" />
