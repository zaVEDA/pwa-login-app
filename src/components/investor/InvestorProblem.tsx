...
const problems = [
  {
    icon: "GraduationCap",
    tag: "Нелогично",
    title: "Покупают сервис для обучения ради базовых документов",
    text: "Чтобы оформить элементарную рассрочку для клиента или подписать согласие на обработку персональных данных, помогающие специалисты вынуждены приобретать обучающие платформы — только ради пары нужных шаблонов.",
  },
  {
    icon: "Banknote",
    tag: "Дорого",
  ...
  },
  {
    icon: "CircleHelp",
    tag: "Бесполезно",
    title: "Консультации за небольшие деньги не дают результата",
    text: "Многие обращались к знакомым или шли на дешёвые консультации — и получали либо огромный непонятный список задач, либо вообще ничего конкретного. Деньги потрачены, ясности нет.",
  },
  {
    icon: "Puzzle",
    tag: "Сложно",
