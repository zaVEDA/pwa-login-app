...
const problems = [
  ...
  },
  {
    ...
    text: "Вместо того чтобы уделяя 10-15 мин в день не ведение учета, специалист просто не оформляет документы вовсе. Никаких договоров, никаких актов — только надежда, что «пронесёт».",
  },
  {
    icon: "DoorOpen",
