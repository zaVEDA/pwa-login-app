...
const problems = [
  {
    ...
    text: "Чтобы оформить элементарную рассрочку для клиента или подписать согласие на обработку персональных данных, помогающие специалисты вынуждены приобретать обучающие платформы.",
  },
  {
    icon: "Banknote",
    tag: "Дорого",
