...
const problems = [
  {
    icon: "GraduationCap",
    tag: "Нелогично",
    title: "Покупают доступ к большим платформам для клиентов",
    text: "Чтобы оформить элементарную рассрочку для клиента или подписать согласие на обработку персональных данных, помогающие специалисты вынуждены приобретать доступы к образовательным платформам для своих клиентов.",
  },
  {
    icon: "Banknote",
    tag: "Дорого",
