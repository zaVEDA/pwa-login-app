    ...
    <>
      ...
      <section className="px-5 py-10 max-w-3xl mx-auto">
        <div className="rounded-3xl p-8 border"
          ...
          <p className="text-sm text-foreground/75 leading-relaxed mb-4">
            Опыт моих клиентов, которые приходили на консультации с разными проблемами — дал понимание вариантов действий предпринимателей в разных ситуациях, которые изначально можно избежать. Эти знания будут положены в мини-справки к документам и позволят избежать неприятностей с потерей времени и денег.
          </p>
