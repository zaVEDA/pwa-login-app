...
const milestones = [
  { done: true, text: "Запущена первая версия" },
  { done: true, text: "Получены отзывы от первых пользователей" },
  { done: true, text: "Подключена система оплат" },
  { done: true, text: "Регистрация есть" },
  { done: false, text: "Наполнение приложения" },
  { done: false, text: "Проверка шаблонов юристом" },
  { done: false, text: "Лояльность соц. сети" },
