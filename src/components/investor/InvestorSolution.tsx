        ...
        <div className="rounded-3xl p-8 border"
          ...
          <div className="flex items-center gap-5 mb-6">
            <img
              ...
              style={{ borderColor: "hsl(35 72% 48% / 0.3)" }}
            />
            <div>
              <h2 className="font-cormorant text-3xl font-semibold mb-1" style={{ color: "hsl(24 20% 13%)" }}>
                Юлия Кузнецова
              </h2>
              <p className="text-sm text-muted-foreground">17 лет в бухгалтерском и налоговом учёте</p>
            </div>
          </div>
          ...
          <p className="text-sm text-foreground/75 leading-relaxed mt-4">
            За стоимость среднего тарифа невозможно очно оказать качественную консультацию, а тем более вести учёт документооборота такому количеству людей. Но я заметила другое: алгоритм работы с документами у помогающих специалистов, самозанятых и ИП — практически одинаковый. Именно поэтому решение реализовано через мобильное приложение: один раз выстроенный процесс работает для всех.
          </p>
        </div>
      </section>
