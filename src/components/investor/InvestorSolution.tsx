    ...
    <>
      ...
      <section className="px-5 py-12 max-w-3xl mx-auto">
        <div className="rounded-3xl p-8 border"
          ...
          <p className="text-sm text-foreground/75 leading-relaxed mb-4">
            Мы верим во взрослую позицию пользователя: сервис ведёт учёт, подписывает документы электронно, напоминает о датах, суммах лимитов и рекомендациях. Но решение — когда и как платить налоги и подавать отчётность — всегда остаётся за клиентом.
          </p>
