      ...
      <section className="px-5 py-12 max-w-3xl mx-auto">
        <div className="rounded-3xl p-8 border"
          ...
          <p className="text-sm text-foreground/75 leading-relaxed mt-4">
            За стоимость среднего тарифа невозможно вручную оказать качественную консультацию, а тем более вести учёт документооборота такому количеству людей. Но я заметила другое: алгоритм работы с документами у помогающих специалистов, самозанятых и ИП — практически одинаковый. Именно поэтому решение реализовано через мобильное приложение: один раз выстроенный процесс работает для всех.
          </p>
        </div>
      </section>
